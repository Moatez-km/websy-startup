  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl">
        <FadeIn delay={0} y={40}>
          <h2 className="text-[#0C0C0C] font-black uppercase text-center text-[clamp(3rem,12vw,160px)] mb-16 sm:mb-20 md:mb-28 leading-none select-none">
            Services
          </h2>
        </FadeIn>
          ...
          {SERVICES.map((service, i) => (
            ...
            >
              ...
              <div
                ...
                className="font-black text-[#0C0C0C] leading-none select-none min-w-[70px] sm:min-w-[130px] md:min-w-[170px]"
              >
                {service.num}
              </div>
              ...
              <div className="flex flex-col gap-2">
                <h3
                  ...
                  className="font-medium uppercase text-[#0C0C0C] select-none"
                >
                  {service.name}
                </h3>
                <p
                  style={{ fontSize: 'clamp(0.85rem, 1.6vw, 1.25rem)' }}
                  className="font-light leading-relaxed max-w-2xl text-[#0C0C0C] opacity-60 select-none"
                >
                  {service.desc}
                </p>
              </div>
